      ...
      <footer>
        <div className="ui stackable grid three column center aligned container">
          <div className="column">
            <img
              src="https://i.ibb.co/g3XJxD3/logo.png"
              width="192"
              height="58"
              alt=""
            />
          ...
          <div className="column">
            <h3>Made by: </h3>
            <a
              href="https://github.com/daveflr"
              className="large ui circular github icon button"
            >
              <i className="github icon" /> Daveflr
            </a>
            <a
              href="https://github.com/brandonjoker17"
              className="large ui circular github icon button"
            >
              <i className="github icon" /> brandonjoker17
            </a>
          </div>
        </div>
      </footer>
